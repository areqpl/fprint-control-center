# fprint-control-center v1.7.0

[![Version](https://img.shields.io/badge/version-1.7.0-blue.svg)](https://github.com/areqpl/fprint-control-center)
...
├── pkgbuild/
│   └── PKGBUILD                        # Arch Linux package build script (v1.7.0)
├── resources/
